...
class ATTGateway
{
	public:
		//create the object
		ATTGateway(String gatewayType, String clientId, String clientKey);
	...
	private:	
		...
		String _gatewayType;			//the type of the gateway: used to create unique id's for the devices (if the local device id's are based on mac addresses or something similar, like for xbee.
