...
void setup()
{
  ...
  {
    Device.AddAsset(AnalogSensor, "YourAnalogSensorname", "Analog Sensor Description", false, "{\"type\": \"integer\", \"unit\":\"watt\"}");        // Create the Analog Sensor asset for your device
